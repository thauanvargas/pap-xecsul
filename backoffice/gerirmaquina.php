...
$order = "ALTER produtos
        ...
        SET
		 ...
		 Vol_MedImp='$vol_medimp',
		 Qualidade='$qualidade',
		 Formato-Max='$formato_max',
		 Gramagem_Max='$gramagem_max',
		 Duplex='$duplex',
		 ...
		 Cores='$cores',
		 Preto_Branco='$peb',
		 Preco='$preco' WHERE N_serie='$numSerie';
		";
...
if($result){
    ...
    echo("<script>alert('Maquina alterada com Sucesso!')</script>");
	$url = '/gerirmaquina.php?add=Impressoras';
		  ...
		  <form method="get">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown"><a data-toggle="dropdown" class="dropdown-toggle">Remover<b class="caret"></b></a>
                ...
                <ul class="dropdown-menu">
                  <li><a href="geririmp.php?add=Impressoras">Impressoras</a></li>
                  <li><a href="geririmp.php?add=Multifuncionais">Multifuncionais</a></li>
...
<div class="container">
<h1 style="text-align:center;">Alterar <?php echo $item; ?></h1>
  <form id="add-form" method="get" enctype="multipart/form-data">
	...
	<option value="multifuncoes">Multifuncionais</option>
	</select>
