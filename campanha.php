...
<html>
  ...
  <body>
		...
		<a class="" href="index.php"><img style="margin: 0px 15px 15px 0px;position:absolute;left:10px;top:5px;width:9%;" src="img/xecsulpic.jpg"/></a>
		  ...
		  <form method="get">
            <ul class="nav navbar-nav">
			  ...
			  <li class="active" ><a href="campanha.php">Campanha</a></li>
	...
	<img style="margin-left:auto;margin-right:auto;display:block; " src="img/campanha.jpg"  >
	<!-- *** CAROUSEL ***
	Slideshow container 

<div style="display:absolute;" id="myCarousel" class="carousel slide" data-ride="carousel">
  <!-- Indicators
...
.carousel-inner > .item > img {
  ...
  <div class="carousel-inner" >
    <div class="item active">
      <img src="img/DocuColour560.jpg" >
    </div>

    <div class="item">
      <img  src="img/WorkCentre6027.jpg"  >
    </div>

    <div class="item">
      <img  src="img/WorkCentre7225.jpg">
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <section>
      <div class="container fixed-bottom">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input action="loja/payment.php" class="btn btn-danger" value=""  onclick="msg()">
		</form>
	...
	<script>
        ...
        <p class="lead">Aqui dispõe dos últimos equipamentos a chegar à nossa loja. </p>
      </div>
    </section>-->
    <!-- Pensando -->
